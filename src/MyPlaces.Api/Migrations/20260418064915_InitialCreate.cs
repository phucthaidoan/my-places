        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourcePlaceId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlacePhotos_PlaceId_SortOrder",
                table: "PlacePhotos",
                columns: new[] { "PlaceId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_Places_City_UserId",
                table: "Places",
                columns: new[] { "City", "UserId" });

            migrationBuilder.CreateIndex(
                name: "IX_Places_UserId_CreatedAt",
                table: "Places",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_UserId_CreatedAt",
                table: "Trips",
                columns: new[] { "UserId", "CreatedAt" });
        }
